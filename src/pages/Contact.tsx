  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Phone Support",
      details: "+91-8237060019",
      subtitle: "24/7 Emergency Helpline",
      action: () => window.open("tel:+918237060019", "_self"),
    },
    {
      icon: Mail,
      title: "Email Support",
      details: "8waterprojects8@gmail.com",
      subtitle: "Response within 4 hours",
      action: () => window.open("mailto:8waterprojects8@gmail.com", "_self"),
    },
    {
      icon: MapPin,
      title: " Location",
      details: "Pune",
      subtitle: "RMDSSOE",
      action: () => window.open("https://www.google.com/maps/place/RMD+SINHGAD+TECHNICAL+INSTITUTE+CAMPUS", "_blank"),
    },
    {
      icon: Clock,
